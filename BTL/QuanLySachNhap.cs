...
namespace BTL
{
    internal class QuanLySachNhap
    {
        private StreamReader sr;
        private StreamWriter sw;
        private string tentep = "sachnhap.txt";
        private string chitiet = "chitietsachnhap.txt";
        private QuanLySachNhap quanLySachNhap;
        public QuanLySachNhap()
        {
        }
        ...
        public void HienChitiet()
        {
            ...
            while ((s = sr.ReadLine()) != null)
            {
                ...
                if (tmp[0] == masach)
                {
                    // masach ten sach,tentg, the loai, NXB, ngay nhap,gianhap
        ...
        public void Them()
        {
            ...
            while (true)
            {
                ...
                string gianhap = Console.ReadLine();

                DateTime ngayNhap = DateTime.MinValue; 
                bool ngayHopLe = false;
                while (!ngayHopLe)
                {
                    Console.Write("Nhap ngay nhap (dd/MM/yyyy): ");
                ...
                sw.WriteLine($"{masachct}.{tensachct}.{tenTG}.{theloai}.{NXB}.{ngayNhap.ToString("dd/MM/yyyy")}.{gianhap}");
